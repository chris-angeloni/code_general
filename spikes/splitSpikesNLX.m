function [block, cellInfo, labels] = splitSpikesNLX(root,templateDir,drift_correct)
...
laserOn = events.times{2,1};  % changed from 4 to 2 for NLX formatting
laserOff = events.times{2,2}; % changed from 4 to 2 for NLX formatting
