%
%function [sr,nchan,data]=readaiffdec(filename,nch,sr,nsample,samplesize)
%function [sr,nchan,data]=readaiffdec(filename)
%	
%	FILE NAME 	: readaiffdec
...
%  for i=1:tsize
%    if strcmp(dec2hex(temp(i)),'434F4D4D')
  for i=1:tsize
...
for j=1:4
  ...
  for i=1:tsize
%    if strcmp(dec2hex(temp(i)),'53534E44')
