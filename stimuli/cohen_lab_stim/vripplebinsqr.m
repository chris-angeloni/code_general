%
%function []=vripplebinsqr(outfile,f1,f2,Fm1,Fm2,FM,RD,M,Fs,NS,MinCorr,MaxCorr,RP,alpha,calib)
%
...
%       MinCorr         : Minimum Correlation Coefficient (0-1)
...
for k=1:NS
	Corr(k,:)=0.5*(MaxCorr-MinCorr)*(1+sin(2*pi*RD*X(k)+2*pi*FM*(1:MEnv)/FsEnv+RP))+MinCorr;
end
