%
% function [FTC] = onlineftc16(TankFileName,BlockNumber,T1,T2,ServerName)
%
...
%                     all units
%
function [FTC16] = onlineftc16v66(TankFileName,BlockNumber,T1,T2,ServerName,Order)
...
for chan=1:16
    ...
    %Reading Tank Data
    [Data] = readtankv66(TankFileName,BlockNumber,chan,ServerName);
