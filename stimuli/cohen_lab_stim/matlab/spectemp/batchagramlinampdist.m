%
%function []=batchagramlinampdist(f1,f2,Fs,dT,faxis,ND)
%
%	FILE NAME 	: BATCH AGRAM LIN AMP DIST
%	DESCRIPTION 	: Batch for Emperically estimating the Lin Contrast 
...
for k=1:size(Lst,1)
	...
	if exist(filename)
		%Evaluating AGRAMLINAMPDIST and Saving to File
		agramlinampdist(header,f1,f2,dT,faxis,Fs,'n','y'); 
	end
end
