%
%function [spetJ1,spetJ2]=spetaddjittermr(paramfile,spet,Trig,Fss,T,Xc)
%
%       FILE NAME       : SPET ADD JITTER MR
%       DESCRIPTION     : Adds jitter to a MR response. Searches for the FM
%                         paramater and adds uniformly distributed jitter
%                         with an upper limit of exactly 1/2 period.
%
...
%RETURNED VARIABLES
%
%	spetJ1  : Jittered spike train for channel 1
%   spetJ2  : Jittered spike train for channel 2
%
function [spetJ1,spetJ2]=spetaddjitter(paramfile,spet,Trig,Fss,T,Xc)
