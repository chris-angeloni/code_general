%
%function [InfoData]=infwordrasterperiodic2(RASTER,B,Fm,T)
%
...
%
% (C) Monty A. Escabi, Aug. 2008 (Edit March 2010)
%
function [InfoData]=infwordrasterperiodic2(RASTER,Fsd,Fm,TW,T)
...
Wt=zeros(BW,Ntrials*Ncycles);
Pt=[];
for k=1:BP %This loop is used to change the phase value so that all phases are considered
...
[RASTERc]=raster2partialcyclerastermatrix(RASTER,Fm,T,Fsd,TW,(k-1)/Fsd);
%imagesc(RASTERc),pause(0.5)
