%
%function []=ripnoised(filename,f1,f2,fRD,fFM,fFm,MaxRD,MaxFM,MinFm,MaxFm,App,M,Fs,NS,DF,AmpDist)
%
%	
%	FILE NAME 	: RIP NOISE D
...
for k=2:N-1:Mn-N-1
	...
	%Generating Ripple Noise
	[Y,phase,SpecProf,faxis,taxis]=noisegensind(f1,f2,RDint,RPint,PFmint,Fmint,App,Fs,phase,fphase,K,MaxRD,MaxFM,DF,AmpDist,NS);
	clear RDint RPint
