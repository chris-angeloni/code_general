%
%function []=mtfsamnoisegen(outfile,BW,Fm,gamma,T,Tpause,Fs,L)
%
%   FILE NAME   : MTF SAM NOISE GEN
%   DESCRIPTION : Generates a .RAW and .WAV file which is used for 
%			      Noise MTF Experiment. SAM modulated noise.
%
...
FM=FM(index);
f=['save ' outfile '_param.mat BW Fm gamma T Tpause Fs L FM'];
eval(f);
