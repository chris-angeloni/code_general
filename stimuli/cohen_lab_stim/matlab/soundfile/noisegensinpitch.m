%
%function [Y,phase,SpecProf,faxis,taxis]=noisegensinpitch(f1,f2,RD,RP,PFm,dFm,App,Fs,phase,fphase,K,MaxRD,MaxFM,DF,AmpDist,NS)
%	
%	FILE NAME 	: RIP GEN SIN PITCH
%	DESCRIPTION 	: Dynamic Ripple Spectrum Noise With Dynamic Pitch
%			  Generator via sinusoid bank
%			  This file is used by RIPNOISEBPITCH
