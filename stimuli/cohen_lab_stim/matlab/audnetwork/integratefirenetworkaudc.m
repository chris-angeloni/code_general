%
%function [AudNetData]=integratefirenetworkaud(S,Nlayer,Nnode,TauE,TauI,Tref,Nsig,SNR,SigE,SigI,EIR,Fs,flag,detrendim,detrendin)
%
...
%        [Y]=integratefirenetworklayer(S,Nnode(1),TauE(1),TauI(1),Tref,Nsig(1),SNR(1),SigE(1),SigI(1),EIR(1),Fs,flag,'y','n');
        ...
        [Y]=integratefirenetworkcontmulti(S,Nnode(1),TauE(1),Tref(1),Nsig(1),SNR(1),SigE(1),SigI(1),EIR(1),Fs,flag,'y','n');
        ...
        for l=2:Nlayer
            ...
            [Y]=integratefirenetworklayer(full(AudNetData.Layer(l-1).Y{n}),Nnode(l),TauE(l),TauI(l),Tref,Nsig(l),SNR(l),SigE(l),SigI(l),EIR(l),Fs,flag,'y','n');
