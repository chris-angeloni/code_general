%
%function [RFParamb]=strfparamboot(taxis,faxis,STRFb,Wo,PP,Sound,Threshs,NB,MaxFm,MaxRD,Thresh,alpha1,alpha2,Disp)
%
...
%                     transform on STRF
%
% (C) Monty A. Escabi, December 2005 (Edit January 2009)
%
function [RFParamb]=strfparamboot(taxis,faxis,STRFb,Wo,PP,Sound,Threshs,NB,MaxFm,MaxRD,Thresh,alpha1,alpha2,Disp)
...
for k=1:NB
   ...
   %Bootstrapping STRFPARAM
   [RFParamb(k)]=strfparam(taxis,faxis,STRF,Wo,PP,Sound,MaxFm,MaxRD,Thresh,alpha1,alpha2,Disp)    
end