%
%function [Fo,Fi]=lierr(Fo,Fs,M,gamma,f1,f2,alpha,Phase)
%
%       FILE NAME       : LI ERR
%       DESCRIPTION     : Evaluates the Error that results from the 
%			  Linear Interpolation aproach of finding To.
...
%
function [Fo,Fi,Phase]=lierr(Fo,Fs,M,gamma,f1,f2,alpha,Phase)
