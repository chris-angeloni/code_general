%
%function [Fo,Fi]=ererr(Fo,Fs,M,gamma,f1,f2,alpha,Phase)
%
%       FILE NAME       : ER ERR
%       DESCRIPTION     : Evaluates the Error that results from the 
%			  Escabi/Roark Interpolation aproach of finding To.
...
%	Phase		: Phase Signal Array - Optional 
%
%	Fo		: Extracted Fo Array
%	Fi		: Instantenous Fo Array
%	Phase		: Phase Signal Array
%
function [Fo,Fi,Phase]=ererr(Fo,Fs,M,gamma,f1,f2,alpha,Phase)
...
%Finding Instantenous Frequency Using LI aproach
[To]=er(x,Fs);
Fo=1./To;
tt=0;
for k=2:length(To)
