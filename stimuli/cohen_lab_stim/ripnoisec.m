%
%function []=ripnoisec(filename,f1,f2,fRD,fFM,fFm,MaxRD,MaxFM,MinFm,MaxFm,App,M,Fs,NS,Axis,DF,AmpDist)
%
%	
%	FILE NAME 	: RIP NOISE C
%	DESCRIPTION 	: Generates Dynamic Moving Ripple
...
%	fFm		: Fine structure temporal mod bandlimit frequency
%	MaxRD		: Maximum Ripple Density ( Cycles / Octaves )
%	MaxFM		: Maximum Ripple Modulation Frequency ( Hz )
%	MinFm		: Maximum Fine Structure Modulation Frequency ( Hz )
%	MaxFm		: Minimum Fine Structure Modulation Frequency ( Hz )
...
%Generating Fine Structure Modulation Signal
...
[Y,phase,SpecProf,faxis,taxis,AF]=noisegensinc(f1,f2,RDint,RPint,PFmint,App,Fs,phase,fphase,K,MaxRD,MaxFM,Axis,DF,AmpDist);
	clear RDint RPint
	...
	%Writing Fine Scale Modulation Signal
	tofloat([filename '.am'],AF)
	clear AF
